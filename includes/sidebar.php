    ...
    <div class="app-header__menu">
        ...
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <li class="app-sidebar__heading">ДОСТУПНЫЕ ЭКЗАМЕНЫ</li>
                <li>
                <a href="#">
                ...
                <ul >
                 ...
                 <li class="app-sidebar__heading">СДАННЫЕ ЭКЗАМЕНЫ</li>
                <li>
                  <?php 
                    ...
                    { ?>
                        <a href="#" class="pl-3">Вы еще не сдаете экзамен</a>
                    <?php }
                ...
                <li class="app-sidebar__heading">ВОПРОСЫ</li>
                <li>
